...
class CollectTrainingStatsApp(switch.SimpleSwitch13):
    def __init__(self, *args, **kwargs):
        ...
        file0 = open("/ryu/app/FlowStatsfile.csv","w")
        ...
        if out_port != ofproto.OFPP_FLOOD:
            if eth.ethertype == ether_types.ETH_TYPE_IP:
                ...
                if protocol == in_proto.IPPROTO_TCP:
                    ...
                    match_fields['ip_proto'] = protocol
                    match_fields['tcp_src'] = t.src_port
                    match_fields['tcp_dst'] = t.dst_port
                elif protocol == in_proto.IPPROTO_UDP:
                    u = pkt.get_protocol(udp.udp)
                    match_fields['ip_proto'] = protocol
                    match_fields['udp_src'] = u.src_port
                    match_fields['udp_dst'] = u.dst_port
                elif protocol == in_proto.IPPROTO_ICMP:
                    ic = pkt.get_protocol(icmp.icmp)
                    match_fields['ip_proto'] = protocol
                    match_fields['icmpv4_type'] = ic.type
                    match_fields['icmpv4_code'] = ic.code
